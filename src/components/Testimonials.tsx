    ...
    <section className="py-20 md:py-28 bg-muted">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <div
            className="mt-8 w-16 h-1 mx-auto rounded-full bg-primary"
          ></div>
        </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center mb-6">
                  <Avatar className="h-16 w-16 mr-4 border-2 border-accent">
                    ...
                    <AvatarFallback
                      className="text-secondary-foreground font-semibold text-lg bg-secondary"
                    >
                ...
                <div className="relative">
                  <div
                    className="absolute -top-2 -left-2 text-6xl font-serif opacity-20 text-accent"
                  >
                    &ldquo;
                  </div>
                  <p
                    className="text-base leading-relaxed relative z-10 text-card-foreground"
                  >
                    {testimonial.content}
                  </p>
                </div>
        ...
        <div className="mt-20 text-center">
          <div
            className="inline-flex items-center justify-center space-x-12 px-12 py-8 rounded-2xl border bg-card border-accent"
          >
            <div className="text-center">
              <div
                className="text-3xl font-bold mb-1 text-primary"
              >
                1,000&#43;
              </div>
              <div
