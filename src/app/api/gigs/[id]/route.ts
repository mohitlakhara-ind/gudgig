...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ success: false, message: 'Failed to update gig' }, { status: 502 });
  } catch (error) {
    return NextResponse.json({ success: false, message: 'Error updating gig' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ success: false, message: 'Failed to delete gig' }, { status: 502 });
  } catch (error) {
    return NextResponse.json({ success: false, message: 'Error deleting gig' }, { status: 500 });
  }
}
